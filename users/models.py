...
class Profile(models.Model):
    ...
    social_github = models.CharField(max_length=2000, blank=True, null=True)
    social_twitter = models.CharField(max_length=2000, blank=True, null=True)
    social_linkedin = models.CharField(max_length=2000, blank=True, null=True)
    social_youtube = models.CharField(max_length=2000, blank=True, null=True)
